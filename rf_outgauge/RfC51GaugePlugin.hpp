#ifndef GAUGE_HPP_INCLUDED
#define GAUGE_HPP_INCLUDED
...
class RfC51GaugePlugin : public InternalsPluginV3
{
private:
...
public:
    ...
    static const unsigned GetType()
    {
        return PO_INTERNALS;
    }
    static const char *   GetSubType()
    {
        return m_szSubType;
    }
    static const unsigned GetVersion()
    {
        return m_uVersion;
    }
    ...
    void                  Destroy()
    {
        Shutdown();    // poorly named ... doesn't destroy anything
    }
    ...
    PluginObjectProperty *GetProperty( const char * )
    {
        return 0;
    }
    PluginObjectProperty *GetProperty( const unsigned )
    {
        return 0;
    }
    ...
    // GAME OUTPUT
    bool WantsTelemetryUpdates()
    {
        return (true);    // CHANGE TO TRUE TO ENABLE TELEMETRY EXAMPLE!
    }
    void UpdateTelemetry( const TelemInfoV2 &info );

    bool WantsGraphicsUpdates()
    {
        return( false );    // CHANGE TO TRUE TO ENABLE GRAPHICS EXAMPLE!
    }
    ...
    {
        return( false );    // CHANGE TO TRUE TO ENABLE HARDWARE EXAMPLE!
    }
    ...
    {
        return (false);    // SEE FUNCTION BODY TO ENABLE FORCE EXAMPLE
    }

    // SCORING OUTPUT
    bool WantsScoringUpdates()
    {
        return( false );    // CHANGE TO TRUE TO ENABLE SCORING EXAMPLE!
    }
    ...
    {
        return (false);
    };  // SEE FUNCTION BODY TO ENABLE COMMENTARY EXAMPLE


};


#endif // GAUGE_HPP_INCLUDED
